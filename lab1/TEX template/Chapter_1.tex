...
\underline{Salvarea starii fisierelor} sau intregului proiect se efectueaza utilizint comenzile de baza pe care le contine Git. Ele ne permit gestionarea procesului de versionare. Voi prezenta citeva din cele utilizate insa ele contin o multime destul de vasta si este nevoie de practica pentru a percepe modul de functionare si pentru a capata deprindere de utilizare.

\begin{quote}
	{\tt\$git add "nume-fisier"} Momentan starea acestui fisier se stocheaza temporar in "index", insa pentru a adauga permanent se utilizeaza: \\
	{\tt\$git commit -m "comentariu"} ce inregistreaza modificarile fisierilor in git.\\
	{\tt\$git reset "nume-fisier"}
	\$git config --global user.email "some@email.com" 
\end{quote}

\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{img/base_comand}
	\caption{}
	\label{fig:basecomand}
\end{figure}


Un alt mecanizm ce ne ofera sistemul git este ramificarea starilor.
